//package ru.murtazin.homeworks.homework15.task45;
///**
// * ДЗ (45)
// * Реализовать классы музыкантов, которые играют на гитаре и клавишных. Каждый класс должен
// * возвращать по методу описания строку с именем музыканта и названием инструмента на котором играет.
