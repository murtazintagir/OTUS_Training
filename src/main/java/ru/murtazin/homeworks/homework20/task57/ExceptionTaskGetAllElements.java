package ru.murtazin.homeworks.homework20.task57;

/**
 * ДЗ (57)
 * Доработайте метод getAllElements так,
 * чтобы в случае возникновения ошибки он в качестве результата записывал в список сообщение выброшенного исключения,
